...
- **OAuth 2.0 Redirect URIs**:
  ...
  - Production Website: `https://YOUR_DOMAIN/oauth/roblox/callback`
...
- **Interactions Endpoint URL**:
  ...
  - **Future Webhook Setting**: `https://YOUR_DOMAIN/api/discord/interactions`
...
- **Linked Roles Metadata URL**:
  - `https://YOUR_DOMAIN/api/discord/linked-roles/metadata`
